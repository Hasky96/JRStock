...
const dayData2 = dayData.map((data) => {
  return {
    ...data,
    value: data.value - Math.random(),
  };
});

const weekData2 = weekData.map((data) => {
  return {
    ...data,
    value: data.value - Math.random(),
  };
...
const monthData2 = monthData.map((data) => {
  return {
    ...data,
    value: data.value - Math.random(),
  };
...
const yearData2 = yearData.map((data) => {
  return {
    ...data,
    value: data.value - Math.random(),
  };
